...
- Compares two pipelines of SVD + kNN and Masked Autoencoder + kNN
- Integrates a hybrid model of OpenAI-generated personas (preferences) + Sparse fragrance encodings for Affinity.
- Uses Maximum Marginal Relevance to reorder recommender rankings to output more diverse recommendations. 
